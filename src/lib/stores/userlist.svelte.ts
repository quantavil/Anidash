...
import { getAllEntries, getListEntry, putEntry, updateEntry, removeEntry } from '$lib/cache/userlist.cache';
...
function createUserListStore() {
  ...
  return {
    ...
    get onHold() { return onHold; },
    get dropped() { return dropped; },
    get planToWatch() { return planToWatch; },
