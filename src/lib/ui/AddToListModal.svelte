...
<Dialog.Root {open} onOpenChange={onOpenChange}>
  <Dialog.Portal>
    ...
    <Dialog.Content class="fixed left-1/2 top-1/2 z-50 w-full max-w-sm -translate-x-1/2 -translate-y-1/2 rounded-xl border border-border bg-surface-1 p-6 shadow-2xl">
      <!-- Anime preview -->
