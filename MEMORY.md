...
- [2026-06-14] Search bars didn't extend to full width and still had focus rings → ROOT CAUSE: `sm:max-w-md` still limited width, and `focus:ring` was present. → FIX: Switched to `flex-1 min-w-[200px]` for full extension and removed all focus rings/borders, utilizing only `focus:bg-white/10`.
